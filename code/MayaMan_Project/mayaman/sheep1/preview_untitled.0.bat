...
set RIB_DIR=F:\book\MayaMan_Project\mayaman\sheep1
...
call %MAYAMANROOT%\bin\manstat "%RIB_DIR%/shaders/mms_sheep1_phong1.slo" "%RIB_DIR%/shaders/mms_sheep1_phong1.sl"
if errorlevel 1 call "%RMANTREE%\%SHADERCOMPILER%" %SHADERCOMPILERARGS% -I"%MAYAMANROOT%\shaders" -o "%RIB_DIR%/shaders/mms_sheep1_phong1.slo" "%RIB_DIR%/shaders/mms_sheep1_phong1.sl"
if errorlevel 1 goto :label_COND_FAILURE

call %MAYAMANROOT%\bin\manstat "%RIB_DIR%/shaders/mms_sheep1_phong2.slo" "%RIB_DIR%/shaders/mms_sheep1_phong2.sl"
if errorlevel 1 call "%RMANTREE%\%SHADERCOMPILER%" %SHADERCOMPILERARGS% -I"%MAYAMANROOT%\shaders" -o "%RIB_DIR%/shaders/mms_sheep1_phong2.slo" "%RIB_DIR%/shaders/mms_sheep1_phong2.sl"
if errorlevel 1 goto :label_COND_FAILURE

call %MAYAMANROOT%\bin\manstat "%RIB_DIR%/shaders/mms_blinn1.slo" "%RIB_DIR%/shaders/mms_blinn1.sl"
if errorlevel 1 call "%RMANTREE%\%SHADERCOMPILER%" %SHADERCOMPILERARGS% -I"%MAYAMANROOT%\shaders" -o "%RIB_DIR%/shaders/mms_blinn1.slo" "%RIB_DIR%/shaders/mms_blinn1.sl"
if errorlevel 1 goto :label_COND_FAILURE
