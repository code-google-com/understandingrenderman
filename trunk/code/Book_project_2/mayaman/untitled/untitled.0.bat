@echo off
title Rendering F:\book\Book_project_2\mayaman\images\untitled.tif
...
set RIB_DIR=F:\book\Book_project_2\mayaman\untitled
set TEX_CACHE=F:\book\Book_project_2\mayaman\tex_cache
...
echo Constant Shadow Maps Complete
echo F:/book/Book_project_2/mayaman/images/untitled.tif
if exist "F:/book/Book_project_2/mayaman/images/untitled.tif" del /F "F:\book\Book_project_2\mayaman\images\untitled.tif"
echo %RIB_DIR%/untitled.0.rib
"%RMANTREE%\%RENDERER%" %RENDER_THREADS% -progress "%RIB_DIR%/untitled.0.rib"
if errorlevel 1 goto :label_RENDERER_FAILURE
if not exist "F:/book/Book_project_2/mayaman/images/untitled.tif" goto label_NO_OUTPUT_FAILURE
